#
#  Be sure to run `pod spec lint ANBlurredImageView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "aaronykng"
  # s.authors            = { "aaronykng" => "aaronykng@gmail.com" }
  ...
  s.source       = { :git => "https://github.com/aaronn/ANBlurredImageView.git", :tag => "0.0.1" }
